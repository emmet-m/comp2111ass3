...
\begin{array}{l}
pre(6) \land t = s[n] \land \kappa_g(t) = k, \\
pre(6) \land t = s[n] \land \kappa_g(t) = k \land v = \lambda_g(t)
\end{array}
\right];$ \\ \\
\tabb \quad $v, f, q, t : \left[ ~pre(6) \land t = s[n] \land \kappa_g(t) = k \land v = \lambda_g(t), post(6) \right]$ \\ \\
%
\tabb \rc{ass} \explain{}  \\
\tabb \quad  v := $\lambda_g(t)$; \\
\tabb \quad $v, f, q, t : \left[ pre(6) \land t = s[n] \land \kappa_g(t) = k \land v = \lambda_g(t), post(6) \right]$ \\
%
...
%
\textcolor{magenta}{la de da enq the shit in (9)}
%
\end{document}
